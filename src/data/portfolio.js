...
export const PROJECTS = [
    ...
    },
    {
        ...
        demo: "",
        slides: [
            { label: "Dashboard", color: "#4F46E5", image: "/project-smartfefo.svg" },
            { label: "QR Scanner", color: "#7C3AED", image: "/project-smartfefo.svg" },
            { label: "FEFO Checkout", color: "#A78BFA", image: "/project-smartfefo.svg" },
            { label: "Audit Trail", color: "#DDD6FE", image: "/project-smartfefo.svg" },
        ],
    },
];